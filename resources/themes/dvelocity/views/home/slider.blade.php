...
@push('scripts')
    <script type="text/x-template" id="slider-template">
        <div class="slides-container {{ $direction }}">
            <div style="display: block;margin: auto;width: 100%;text-align: center;background: #26298e !important;color:azure"><p style="font-size: 20px;margin-top: 0;margin-bottom: 0px;margin-bottom: em;padding: 13px;margin-bottom: 0rem;">Free Delivery on All Orders above £100 in United Kingdom.</p></div>
            <carousel-component
                loop="true"
                timeout="5000"
                autoplay="true"

<script type="text/x-template" id="content-header-template">
    <header class="row velocity-divide-page vc-header active">
        <div class="vc-small-screen container" v-if="isMobile()">
            <div class="row">
                <div class="col-6">
                    <div v-if="hamburger" class="nav-container scrollable">
                        <div class="wrapper" v-if="this.rootCategories">
                            ...
                            <ul type="none" class="velocity-content" v-if="headerContent.length > 0" v-if="!isMobile()">
                ...
                <div class="right-vc-header col-6">
                    @if ($showCompare)
                        <a
                            ...
                            <i class="material-icons" v-if="!isMobile()">compare_arrows</i>
                        </a>
                    @endif

                    <a class="wishlist-btn unset" v-if="!isMobile()" :href="`${isCustomer ? '{{ route('customer.wishlist.index') }}' : '{{ route('velocity.product.guest-wishlist') }}'}`">
                ...
                <div class="right-vc-header col-lg-12" v-if="isMobile()">
        ...
        <div class="content-list right" id="megamenu">
            <div class="main-menu">
                <ul class="clearfix">
                <li v-for="(content, index) in $root.sharedRootCategories" :key="index">
                    <a v-text="content.name"
                    :href="`${$root.baseUrl}/${content['slug']}`" class="mega"></a>
                    <ul v-if="content.children.length > 0">
                    <li>
                        <ul class="megadrop">
                        <li v-for="(child , index) in content.children" :key="index">
                            <a v-text="child.name"
                            :href="`${$root.baseUrl}/${content['slug']}/${child['slug']}`">Lidership</a></li>
                        </ul>
                    </li>
                    </ul>
                </li>

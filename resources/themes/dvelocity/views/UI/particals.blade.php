...
<script type="text/x-template" id="logo-template">
    <a
        ...
        @else
            <img class="logo" src="{{ asset('themes/dvelocity/assets/images/logo-text.png') }}" />
        @endif
    </a>
</script>
                                ...
                                <li v-for="result in results" :key="result.id">
                                    <a target="_blank" v-bind:href="result.url_key" class="row">
                                        <div class="col-xs-4">
                                            ...
                                            width: 170px;" src="{{asset('vendor/webkul/ui/assets/images/product/small-product-placeholder.png')}}" />
                                         <!--   <img v-bind:src="result.image"/> -->
                                        </div>
                                        <div class="col-xs-8">
                                            <p class="search-title" v-text="result.name" > </p>

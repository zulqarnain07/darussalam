...
<div class="col-md-12 py-5">
    ...
    <div class="col-md-6">
        <p style="font-size: 20px;
        font-weight: bold;"><a href="javascript::void(0)">How many pages does this book contain?</a></p>
        <a style="float: right;     font-size: 15px;" href="javascript::void(0)">Add new Answer</a>
        <p style="font-size: 20px" class="pt-5">This book contains 576 Pages.</p>
...
<div class="p-3">
<button style="    font-size: 14px;" type="button" class="btn btn-outline-secondary">Help Full <i style="    font-size: 20px;" class="fa fa-thumbs-up"></i></button>
<button style="    font-size: 14px;" type="button" class="btn btn-outline-primary px-3"> <i class="fa fa-reply" aria-hidden="true"></i> Replay</button>

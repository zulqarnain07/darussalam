...
{!! view_render_event('bagisto.shop.products.review.before', ['product' => $product]) !!}
    ...
    @if ($total)
        @if (isset($accordian) && $accordian)
            <accordian class="ratingaccord" :active="true">
                {{-- customer ratings --}}
                <div slot="header" class="col-lg-12 no-padding">
                    <h3 class="display-inbl">
                        <span>{{ __('velocity::app.products.customer-rating') }}</span>
                    </h3>
                ...
                <div class="row customer-rating" slot="body">
                    <div class="row full-width text-center mb30">
                        <div class="col-md-6">
							<div class="row leftrevbox">
								<div class="col-sm-7">
									<div class="row ratingrow">
										<div class="col-md-4">
											<h4 class="reatingtext">{{ $avgRatings }} {{ __('shop::app.reviews.star') }}</h4>
										</div>
										<div class="col-md-8">
											<div class="starbox">
												<star-ratings
								...
								<div class="col-sm-5">
									@for ($i = 5; $i >= 1; $i--)
										...
										<div class="row">
											...
											<div class="col-5 rating-bar" title="{{ $percentageRatings[$i] }}%">
												<div style="width: {{ $percentageRatings[$i] }}%"></div>
											</div>

											<span class="col-4 no-padding fs16">{{ $percentageRatings[$i] }} %</span>
										</div>
									@endfor
								</div>
							</div>
                ...
                <div class="customer-reviews" slot="body">
                    @foreach ($reviewHelper->getReviews($product)->paginate(10) as $review)
                        <div class="row customrevbox">
                            ...
                            <div class="review-description col-lg-12 padding0">

        ...
        <div class="container-fluid advertisement-four-container">
            <div class="row">
                @if ( isset($advertisementFour[0]))
                    <a @if (isset($one)) href="{{ $one }}" @endif class="col-lg-4 col-12 " aria-label="Advertisement">
                        <img class="col-12 lazyload" data-src="{{ asset('/storage/' . $advertisementFour[0]) }}" alt="" />
                    </a>
                @endif
                @if ( isset($advertisementFour[1]))
                <a @if (isset($two)) href="{{ $two }}" @endif class="col-lg-4 col-12" aria-label="Advertisement">
                    <img class="col-12 lazyload" data-src="{{ asset('/storage/' . $advertisementFour[1]) }}" alt="" />
                </a>
            @endif
            @if ( isset($advertisementFour[2]))
            <a @if (isset($three)) href="{{ $three }}" @endif class="col-lg-4 col-12 " aria-label="Advertisement">
                <img class="col-12 lazyload" data-src="{{ asset('/storage/' . $advertisementFour[2]) }}" alt="" />
            </a>
        @endif
